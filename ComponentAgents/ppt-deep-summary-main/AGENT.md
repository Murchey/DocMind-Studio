...
python SKILLS/PPTFormatting/scripts/ppt_formatting.py WorkSpace/outline.json WorkSpace/report.md --intelligent WorkSpace/intelligent.json

# HTML 格式 — 集成智能分析
python SKILLS/PPTFormatting/scripts/ppt_formatting.py WorkSpace/outline.json WorkSpace/report.html --format html --intelligent WorkSpace/intelligent.json
```
...
3. 将分析结果以 JSON 格式写入 `WorkSpace/intelligent.json`
4. 向用户展示关键发现摘要
...
WorkSpace/intelligent.json   # PPTIntelligent 智能分析输出
